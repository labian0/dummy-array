...
class Library:
    ...
    def benchmark_initialize(self, capacity:int, repetitions:int) -> float:
    ...
    def benchmark_add(self, capacity:int, repetitions:int) -> float:
    ...
    def benchmark_remove(self, capacity:int, repetitions:int) -> float:
    ...
    def benchmark_exists(self, capacity:int, repetitions:int) -> float:
